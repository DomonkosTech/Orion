...
import { sendUserPasswordResetEmail } from "../../../services/emailService";
import styles from "../RegisterPage/UserRegisterPage.module.css";
...
const UserPasswordResetRequest: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("jelszó cserélő link elküldve az email címére!");
            setEmail("");
        } catch (error) {
            ...
            <div className={styles.container}>
                <div className={styles.card}>
                    <header className={styles.header}>
                        <h1>jelszó csere</h1>
                        <p>Kérjük, adja meg az email címét a jelszó cserélő link újraküldéséhez.</p>
                    </header>
